...
\begin{theorem}[Disuguglianza di Bessel]
...
\begin{proof}
	...
	\begin{eqalign*}
		\int_{-1}^1 \der{^n}{x^n} (x^2-1)^n\, \der{^m}{x^m} (x^2-1)^m \,dx &= (-1)^{m+1} \int_{-1}^1 \der{^{n-m-1}}{x^{n-m-1}} (x^2-1)^n\, \der{^{2m+1}}{x^{2m+1}} (x^2-1)^m \,dx.
	\end{eqalign*}
